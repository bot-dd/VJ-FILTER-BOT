...
PICS = (environ.get('PICS', 'https://i.imgur.com/IZaAghr.jpeg https://i.imgur.com/iW9tsz.jpeg https://i.imgur.com/WO5fuPW.jpeg https://i.imgur.com/AYfw2lz.jpeg https://i.imgur.com/bDNYdQ8.jpeg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7822720438 7945551029').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002390337330'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002267680129').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002394229067') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002390337330')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002722173659')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002390337330')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://NMFiles0:mndhdejusj@nmfiles.uc7v47t.mongodb.net/?retryWrites=true&w=majority&appName=NMFiles")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "NMFiles")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'NMFiles')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+6oK0X0MVNsgwMjZl') # Support Chat Link Without https:// or @
